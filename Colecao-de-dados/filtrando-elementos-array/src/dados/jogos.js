export const jogosExclusivos = [
    ...
    {id: 9, nome: "Mario Odissey", plataforma: "nitendo"},
    {id: 10, nome: "Zelda: Tears of Kingdom", plataforma: "nitendo"},
    {id: 11, nome: "Xenoblade Chronicles 3", plataforma: "nitendo"},
    {id: 12, nome: "Pokemon Scarlet & Violet", plataforma: "nitendo"}
];